...
interface AnimatedMagicWandProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
  /** When true, loops the animation infinitely (used by ProcessingOverlay). */
  loop?: boolean;
}
...
AnimatedMagicWand.displayName = "AnimatedMagicWand";

export { AnimatedMagicWand };

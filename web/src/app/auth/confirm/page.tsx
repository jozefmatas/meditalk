  ...
  if (status === "error") {
    return (
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "80px 24px", textAlign: "center", fontFamily: "'Figtree', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
        ...
        <p style={{ fontSize: 15, color: "#232334", opacity: 0.65, marginBottom: 32 }}>
          This magic link has already been used or has expired.
        </p>
        <a
          href="/login"
          style={{ display: "inline-block", backgroundColor: "#4444ff", color: "#fff", fontSize: 15, textDecoration: "none", padding: "12px 32px", borderRadius: 10 }}
        >
          Back to login
        </a>
      </div>
    ...
    <div style={{ maxWidth: 480, margin: "0 auto", padding: "80px 24px", textAlign: "center", fontFamily: "'Figtree', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
      ...
      {status === "idle" && (
        <button
          ...
          style={{ display: "inline-block", backgroundColor: "#4444ff", color: "#fff", fontSize: 15, border: "none", cursor: "pointer", padding: "12px 32px", borderRadius: 10 }}
        >
          Log in to MediTalk
        </button>
      )}

...
async function main(): Promise<void> {
  ...
  const { runSuite, printSuiteReport } = await import(
    "../src/lib/evals/runner"
  );
  const { kovacikovaChestPain } = await import(
    "../src/lib/evals/fixtures/kovacikova-chest-pain"
  );
  ...
  const ALL_FIXTURES = [kovacikovaChestPain];
